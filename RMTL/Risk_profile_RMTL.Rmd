...
plot_risk_profile_grant <- function(tseq_pred,
  ...
  plot_frame <- data.frame(
    ...
    Probability = c(ValPred$p_neither[, i], 
                    ...
                    ValPred$p_both[, i],
                    ValPred$p_nonterm_only[, i]),
    Outcome=factor(x = c(rep("Alive+Healthy",length_tseq),
                         rep("Dead",length_tseq),
                         rep("Shock+Dead",length_tseq),
                         rep("Shock",length_tseq)),
                   levels = c("Alive+Healthy",
                              "Dead",
                              "Shock+Dead",
                              "Shock"))
  )
